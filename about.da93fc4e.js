...
})({"4YvD9":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "bef0ad59da93fc4e";
"use strict";
...
},{}],"fQySb":[function(require,module,exports) {
...
function sendmail({ from, to, email, phone, firstname, lastname, cub, kg, bars }) {
    console.log({
        from,
        to,
        email,
    ...
    (0, _browserDefault.default).send("service_j9lpotb", "template_plzqwhv", {
        from,
        to,
        email,
        phone,
...
const openSearch = document.querySelectorAll(".form__btn");
const submitSearch = document.querySelector(".modal__submit");
const modalSearch = document.querySelector(".modal__wrap");
const modalMessage = document.querySelector(".modal__message");
const modalMessageClose = document.querySelectorAll(".modal__message_close");
...
function onError(text) {
    const errorElem = document.querySelector(".modal__error");
...
submitSearch.addEventListener("click", (e)=>{
    ...
    if (error) return;
    if (!document.querySelector(".modal__checkbox").classList.contains("modal__checkbox_active")) {
        onError("Accept the user agreement!");
        return;
    }
    sendmail(data);
    inputs.forEach((item)=>{
    ...
    document.querySelector(".modal__checkbox").classList.remove("modal__checkbox_active");
    modalSearch.classList.remove("modal__wrap_active");
    modalSearch.classList.add("modal__wrap");
    modalMessage.classList.remove("modal__message");
    modalMessage.classList.add("modal__message_active");
});
modalMessageClose.forEach((btn)=>{
    btn.addEventListener("click", ()=>{
        modalMessage.classList.add("modal__message");
        modalMessage.classList.remove("modal__message_active");
        modalSearch.classList.add("modal__wrap");
        modalSearch.classList.remove("modal__wrap_active");
    });
});
...
const textBox = document.querySelector(".large_text_logo");
if (textBox) {
    const observer = new IntersectionObserver((entries)=>{
        entries.forEach((elem)=>{
            if (elem.isIntersecting) textBox.classList.add("large_text_logo_transition");
            else textBox.classList.remove("large_text_logo_transition");
        });
    });
    observer.observe(document.querySelector(".large_text_logo"));
}
...
},{"../../store/store":"3eehJ","../../utils/validateParams":"5GPWw","../../api/sendPost":"3pmzm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4YvD9","fQySb"], "fQySb", "parcelRequire94c2")

//# sourceMappingURL=about.da93fc4e.js.map
