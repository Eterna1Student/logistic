...
})({"aBxno":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "7dbeadefccaf797c";
"use strict";
...
},{}],"2SlHq":[function(require,module,exports) {
...
function validate() {
    ...
    btn.addEventListener("click", (e)=>{
        e.preventDefault();
        if (email.value == "" || phone.value == "" || firstname.value == "" || lastname.value == "" || message.value == "") emptyerror();
        else {
            sendmail(email.value, phone.value, firstname.value, lastname.value, message.value);
            email.value = "";
            phone.value = "";
            firstname.value = "";
            lastname.value = "";
...
function emptyerror() {
    const message = document.querySelector("#error_form");
...
},{"../../store/store":"3eehJ","../../utils/validateParams":"5GPWw","../../api/sendPost":"3pmzm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aBxno","2SlHq"], "2SlHq", "parcelRequire94c2")

//# sourceMappingURL=contact.ccaf797c.js.map
